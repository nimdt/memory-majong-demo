export const TILE_SET = [
  { symbol: '🀇', name: 'One Bamboo', suit: 'bamboo', accent: 'jade', rank: 1 },
  { symbol: '🀈', name: 'Two Bamboo', suit: 'bamboo', accent: 'jade', rank: 2 },
  { symbol: '🀉', name: 'Three Bamboo', suit: 'bamboo', accent: 'jade', rank: 3 },
  { symbol: '🀊', name: 'Four Bamboo', suit: 'bamboo', accent: 'jade', rank: 4 },
  { symbol: '🀋', name: 'Five Bamboo', suit: 'bamboo', accent: 'jade', rank: 5 },
  { symbol: '🀌', name: 'Six Bamboo', suit: 'bamboo', accent: 'jade', rank: 6 },
  { symbol: '🀍', name: 'Seven Bamboo', suit: 'bamboo', accent: 'jade', rank: 7 },
  { symbol: '🀎', name: 'Eight Bamboo', suit: 'bamboo', accent: 'jade', rank: 8 },
  { symbol: '🀏', name: 'Nine Bamboo', suit: 'bamboo', accent: 'jade', rank: 9 },
  { symbol: '🀐', name: 'One Circle', suit: 'circle', accent: 'blue', rank: 1 },
  { symbol: '🀑', name: 'Two Circle', suit: 'circle', accent: 'blue', rank: 2 },
  { symbol: '🀒', name: 'Three Circle', suit: 'circle', accent: 'blue', rank: 3 },
  { symbol: '🀓', name: 'Four Circle', suit: 'circle', accent: 'blue', rank: 4 },
  { symbol: '🀔', name: 'Five Circle', suit: 'circle', accent: 'blue', rank: 5 },
  { symbol: '🀕', name: 'Six Circle', suit: 'circle', accent: 'blue', rank: 6 },
  { symbol: '🀖', name: 'Seven Circle', suit: 'circle', accent: 'blue', rank: 7 },
  { symbol: '🀗', name: 'Eight Circle', suit: 'circle', accent: 'blue', rank: 8 },
  { symbol: '🀘', name: 'Nine Circle', suit: 'circle', accent: 'blue', rank: 9 },
  { symbol: '🀀', name: 'East Wind', suit: 'wind', accent: 'gold', honor: 'east' },
  { symbol: '🀁', name: 'South Wind', suit: 'wind', accent: 'gold', honor: 'south' },
  { symbol: '🀂', name: 'West Wind', suit: 'wind', accent: 'gold', honor: 'west' },
  { symbol: '🀃', name: 'North Wind', suit: 'wind', accent: 'gold', honor: 'north' },
  { symbol: '🀄', name: 'Red Dragon', suit: 'dragon', accent: 'red', honor: 'red-dragon' },
  { symbol: '🀅', name: 'Green Dragon', suit: 'dragon', accent: 'jade', honor: 'green-dragon' }
];
